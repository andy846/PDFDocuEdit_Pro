...
""")
    ...
    def start_printing(self):
        try:
            ...
            self.print_direct(printer, left_offset, top_offset, right_offset, bottom_offset, fit_to_margin, pages)
    ...
    def print_direct(self, printer, left_offset, top_offset, right_offset, bottom_offset, fit_to_margin, pages):
        ...
        try:
            ...
            for i, page_num in enumerate(pages):
                ...
                # 根據fit_to_margin的值選擇適當的矩形進行縮放和居中計算
                if fit_to_margin:
                ...
                painter.resetTransform()  # 重置繪製操作的坐標系
