...
class ExtractPagesDialog(QDialog):
    def __init__(self, parent=None):
        ...
        layout.addWidget(self.radio_complex_option)
...
""")
    ...
    def setup_button(self, text, callback, icon_path, normal_color='#353535', hover_color='#02F78E'):
